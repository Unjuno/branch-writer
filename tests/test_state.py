...
def test_initialize_state_sets_defaults() -> None:
    ...
    assert state["cursor_loop"]["base_content"] == ""
    assert state["cursor_loop"]["stream_key"] is None
    assert state["cursor_loop"]["error"] is None
